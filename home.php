		...
		<div class="container-fluid">
					...
					<div class="card-body">
						<div class="container-fluid">
							...
							<div class="d-flex w-100 justify-content-center">
								<a href="javascript:void(0)" id="upload_post" class="text-dark post-link px-3 py-1" style="border-radius: 50px !important;"><span class="fa fa-photo-video text-success"></span> Event Details</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="card card-widget post-card" data-id="<?php echo $row['id'] ?>">
              ...
              <?php endif; ?>
                ...
                <button type="button" class="btn btn-block btn-sm like <?php echo $is_liked ?>" data-id="<?php echo $row['id'] ?>"><i class="fas fa-hand-paper"></i> Interested</button>
                <span class="float-right text-muted counts"><span class="like-count"><?php echo number_format($liked) ?></span> <?php echo $liked > 1 ? "likes" : "Interested" ?> - <span class="comment-count"><?php echo number_format($commented) ?></span> comments</span>
              </div>
              <!-- /.card-body -->
