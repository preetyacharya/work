	...
	<form action="" id="manage_post">
		...
		<div class="d-flex w-100 align-items-center">
	        ...
	        <div class="ml-4 text-left" style="width:calc(80%)">
	        	<div><small><b><?php echo ucwords($_SESSION['login_firstname']).' '.$_SESSION['login_lastname'] ?></b></small></div>
		...
		<div class="form-group">
			<textarea name="content" id="content" cols="30" rows="2" class="form-control" placeholder="Want to create an event, <?php echo ucwords($_SESSION['login_firstname']) ?>?" style="resize:none;border: none"><?php echo isset($content) ? $content : '' ?></textarea>
		</div>
		<div class="c-row" id="">
		...
		<div class="card solid">
			<div class="card-body">
				<div class="d-flex justify-content-between align-items-center">
					<small>Add Photos to Your Post</small>
					<span>
...
<div class="modal-footer display py-1 px-1">
	<div class="d-block w-100">
		<button class="btn btn-block btn-warning btn-sm" form="manage_post">POST</button>
	</div>
</div>
